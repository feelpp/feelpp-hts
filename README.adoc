...
image:https://github.com/feelpp/feelpp-ths/workflows/CI/badge.svg[CI]
...
The documentation for feelpp-ths is available at link:https://feelpp.github.io/feelpp-ths[here] and you can build on it for your project by enabling the link:https://docs.github.com/en/pages[github pages] for your repository.

== Renaming the project

By default the project is named  `feelpp-ths` if you cloned the repository `feelpp/feelpp-ths`.
