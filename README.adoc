...
The documentation for feelpp-hts is available at link:https://feelpp.github.io/feelpp-hts[here] and you can build on it for your project by enabling the link:https://docs.github.com/en/pages[github pages] for your repository.

== Renaming the project

By default the project is named  `feelpp-hts` if you cloned the repository `feelpp/feelpp-hts`.
