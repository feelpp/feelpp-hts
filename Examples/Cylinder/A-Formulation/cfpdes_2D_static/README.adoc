...
[source,sh]
----
mpirun -np 16 feelpp_toolbox_coefficientformpdes --config-file=cylinder_erf.cfg
----
...
[cols="a"]
|===
|image::Cylinder/A-Formulation/cfpdes_2D/2D_erf_j.png[,width=800,title="Electric current density stem:[J (A/m^2)]]
|===
...
[cols="a"]
|===
|image::Cylinder/A-Formulation/cfpdes_2D/2D_erf_bz.png[,width=800,title="y-component of the magnetic flux density stem:[B_y (T)]]
|===
