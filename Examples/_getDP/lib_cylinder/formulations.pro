...
FunctionSpace {
    ...
    { Name b_or_h_space ; Type Vector;
        BasisFunction {
            { Name sex ; NameOfCoef aex ; Function BF_VolumeX ;
                Support MagnAnhyDomain ; Entity VolumesOf[ Omega ] ; }
            { Name sey ; NameOfCoef aey ; Function BF_VolumeY ;
                Support MagnAnhyDomain ; Entity VolumesOf[ Omega ] ; }
            { Name sez ; NameOfCoef aez ; Function BF_VolumeZ ;
                Support MagnAnhyDomain ; Entity VolumesOf[ Omega ] ; }
        }
    }
    /*{ Name b_or_h_space ; Type Form2; // To investigate
        BasisFunction {
            { Name psif ; NameOfCoef bf ; Function BF_Facet ;
                Support MagnAnhyDomain ; Entity FacetsOf[ Omega ] ; }
        }
        Constraint {
...
PostProcessing {
    ...
    { Name MagDyn_htot; NameOfFormulation MagDyn_htot;
        Quantity {
            ...
            { Name h; Value{ Local{ [ {h} ] ; In Omega; Jacobian Vol; } } }
            { Name hnorm; Value{ Local{ [ Norm[{h}] ] ; In Omega; Jacobian Vol; } } }
            { Name hx; Value{ Local{ [ CompX[{h}] ] ; In Omega; Jacobian Vol; } } }
            { Name hy; Value{ Local{ [ CompY[{h}] ] ; In Omega; Jacobian Vol; } } }
            ...
            { Name by; Value {
                Term { [ CompY[mu[]*({h})] ] ; In MagnLinDomain; Jacobian Vol; }
                //Term { [ CompZ[mu[{h}] * {h}]*Vector[0,0,1] ] ; In MagnAnhyDomain; Jacobian Vol; }
                }
            }
            { Name bnorm; Value {
                Term { [ Norm[mu[]*({h})] ] ; In MagnLinDomain; Jacobian Vol; }
                //Term { [ CompZ[mu[{h}] * {h}]*Vector[0,0,1] ] ; In MagnAnhyDomain; Jacobian Vol; }
                }
            }
            { Name bplane; Value {
    ...
    { Name MagDyn_avtot; NameOfFormulation MagDyn_avtot;
        Quantity {
            ...
            { Name b; Value{ Local{ [ {d a} ] ;
                In Omega; Jacobian Vol; } } }
            { Name bnorm; Value{ Local{ [ Norm[{d a}] ] ;
                In Omega; Jacobian Vol; } } }
            ...
            ElseIf(Dim == 2)
                ...
                { Name m_avg; Value{ Integral{ [ 0.5 * XYZ[]
                    ...
                    In OmegaC; Integration Int; Jacobian Vol; } } }
                { Name acloss; Value{ Integral{ [ -4 * sigmae[ - Dt[{a}] - {ur} , {d a}] * {a} ] ;
                    In OmegaC; Integration Int; Jacobian Vol; } } }
