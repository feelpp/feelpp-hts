Function{
    ...
    DefineConstant [outputacloss = StrCat[outputDirectory,"/acloss.txt"]];
    ...
    DefineConstant [outputPoint = StrCat[outputDirectory,"/jpoint.txt"]];
    DefineConstant [outputPointx = StrCat[outputDirectory,"/hpointx.txt"]];
    DefineConstant [outputPointy = StrCat[outputDirectory,"/hpointy.txt"]];
    DefineConstant [outputPoint2 = StrCat[outputDirectory,"/apoint.txt"]];
...
Resolution {
    { Name MagDyn;
        ...
        Operation {
            //SetGlobalSolverOptions["-petsc_prealloc 8000"];
...
PostOperation {
    ...
    { Name MagDyn_energy ;
        ...
        Operation{
            ...
            If(formulation == h_formulation || formulation == h_formulation+1 || formulation == coupled_formulation)
                /*
