...
video::yqhEfCOGrXI[youtube, width=720, height=480, opts="autoplay,loop", theme=light]
...
video::5RCtNzpe2TY[youtube, width=720, height=480, opts="autoplay,loop", theme=light]
