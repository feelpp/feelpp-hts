...
video::4k0RAQOwvwM[youtube, width=720, height=480, opts="autoplay,loop", theme=light]
...
.Magnitude of the Magnetic flux density stem:[B (T)]
video::AgSLSLyXVn4[youtube, width=720, height=480, opts="autoplay,loop", theme=light]
...
Download export files to view results on https://www.paraview.org/download/[Paraview] : https://girder.math.unistra.fr/api/v1/folder/64ccc03ab0e9570499e1d076/download[Tapes_TAform_axi.zip]