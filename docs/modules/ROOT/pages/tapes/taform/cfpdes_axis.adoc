...
:description: Magnetic transient model on a HTS stacked tapes geometry surrounded by air in axisymmetric coordinates using the T-A Homogeneous Formulation and the E-J power law
:stem: latexmath
:toc: left
