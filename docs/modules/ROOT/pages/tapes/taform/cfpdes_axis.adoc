...
video::4k0RAQOwvwM[youtube, width=720, height=400, opts="autoplay,loop", theme=light]
...
video::AgSLSLyXVn4[youtube, width=720, height=400, opts="autoplay,loop", theme=light]
