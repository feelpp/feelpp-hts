...
:description: Self-consistent python algorithm to find the critical current Ic, using an axisymmetric magnetic static model with A Formulation and E-J power law
:stem: latexmath
:toc: left
