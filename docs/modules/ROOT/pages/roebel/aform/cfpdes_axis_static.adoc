...
:description: Self-consistent python algorithm to estimate the critical current on axisymmetric magnetic static model with A Formulation and E-J power law
