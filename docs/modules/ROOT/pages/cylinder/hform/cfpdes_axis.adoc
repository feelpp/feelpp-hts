...
:description: Magnetic transient model on a HTS bulk cylinder geometry surrounded by air in axisymmetric coordinates using the H Formulation and the E-J power law
