...
video::jBWlTIlLnSw[youtube, width=720, height=400, opts="autoplay,loop", theme=light]
...
video::STlNSx_-kyU[youtube, width=720, height=400, opts="autoplay,loop", theme=light]
