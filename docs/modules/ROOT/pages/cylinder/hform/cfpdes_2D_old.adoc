...
video::uYFO9JJlgDI[youtube, width=720, height=400, opts="autoplay,loop", theme=light]

=== Magnetic flux density

.Magnetic flux density stem:[B (T)]
video::OF71o5rjNn4[youtube, width=720, height=400, opts="autoplay,loop", theme=light]
