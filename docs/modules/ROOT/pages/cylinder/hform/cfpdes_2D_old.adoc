...
video::uYFO9JJlgDI[youtube, width=720, height=480, opts="autoplay,loop", theme=light]

=== Magnetic flux density

.Magnetic flux density stem:[B (T)]
video::OF71o5rjNn4[youtube, width=720, height=480, opts="autoplay,loop", theme=light]
...
Download export files to view results on https://www.paraview.org/download/[Paraview] : https://girder.math.unistra.fr/api/v1/folder/64ccc02eb0e9570499e1d075/download[Cylinder_Hform_2D.zip]