...
video::iy8hqy8e_1o[youtube, width=720, height=480, opts="autoplay,loop", theme=light]
...
video::lidYEfeiPyY[youtube, width=720, height=480, opts="autoplay,loop", theme=light]
